module NTT#(
    ...
    assign RU_2_i_valid   = BU_1_o_valid;//
    assign RU_2_in_data_u = BU_1_out_data_u;//
    assign RU_2_in_data_d = BU_1_out_data_d;//

    assign BU_2_i_valid   = RU_2_o_valid;
    assign BU_2_in_data_u = RU_2_out_data_u;
    assign BU_2_in_data_d = RU_2_out_data_d;
    ...
    assign RU_3_i_valid   = BU_2_o_valid;//
    assign RU_3_in_data_u = BU_2_out_data_u;//
    assign RU_3_in_data_d = BU_2_out_data_d;//

    assign BU_3_i_valid   = RU_3_o_valid;
    assign BU_3_in_data_u = RU_3_out_data_u;
    assign BU_3_in_data_d = RU_3_out_data_d;
    ...
    assign RU_4_i_valid   = BU_3_o_valid;//
    assign RU_4_in_data_u = BU_3_out_data_u;//
    assign RU_4_in_data_d = BU_3_out_data_d;//

    assign BU_4_i_valid   = RU_4_o_valid;
    assign BU_4_in_data_u = RU_4_out_data_u;
    assign BU_4_in_data_d = RU_4_out_data_d;
    ...
    assign RU_5_i_valid   = BU_4_o_valid;//
    assign RU_5_in_data_u = BU_4_out_data_u;//
    assign RU_5_in_data_d = BU_4_out_data_d;//

    assign BU_5_i_valid   = RU_5_o_valid;
    assign BU_5_in_data_u = RU_5_out_data_u;
    assign BU_5_in_data_d = RU_5_out_data_d;
    ...
    assign RU_6_i_valid   = BU_5_o_valid;//
    assign RU_6_in_data_u = BU_5_out_data_u;//
    assign RU_6_in_data_d = BU_5_out_data_d;//

    assign BU_6_i_valid   = RU_6_o_valid;
    assign BU_6_in_data_u = RU_6_out_data_u;
    assign BU_6_in_data_d = RU_6_out_data_d;
    ...
    assign RU_7_i_valid   = BU_6_o_valid;//
    assign RU_7_in_data_u = BU_6_out_data_u;//
    assign RU_7_in_data_d = BU_6_out_data_d;//

    assign BU_7_i_valid   = RU_7_o_valid;
    assign BU_7_in_data_u = RU_7_out_data_u;
    assign BU_7_in_data_d = RU_7_out_data_d;
