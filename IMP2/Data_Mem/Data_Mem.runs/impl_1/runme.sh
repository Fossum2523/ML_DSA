...
HD_PWD='C:/Users/fossu/Desktop/ML_DSA_Syn_new/IMP2/Data_Mem/Data_Mem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Data_Mem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Data_Mem.tcl -notrace
