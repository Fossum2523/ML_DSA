...
#
# Script generated by Vivado on Tue May 06 12:29:41 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Ture_Dual_Port_RAM_23x1024.sh
...
#
# Usage        : Ture_Dual_Port_RAM_23x1024.sh
#                Ture_Dual_Port_RAM_23x1024.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Ture_Dual_Port_RAM_23x1024.sh [-reset_run]
#                Ture_Dual_Port_RAM_23x1024.sh [-reset_log]
#                Ture_Dual_Port_RAM_23x1024.sh [-help]
#
...
#                script (type 'Ture_Dual_Port_RAM_23x1024.sh -help' for more information).
#
...
# script info
echo -e "Ture_Dual_Port_RAM_23x1024.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Ture_Dual_Port_RAM_23x1024.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Ture_Dual_Port_RAM_23x1024 xil_defaultlib.glbl -o Ture_Dual_Port_RAM_23x1024_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Ture_Dual_Port_RAM_23x1024_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Ture_Dual_Port_RAM_23x1024_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Ture_Dual_Port_RAM_23x1024_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Ture_Dual_Port_RAM_23x1024.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Ture_Dual_Port_RAM_23x1024.sh [-help]\n\
Usage: Ture_Dual_Port_RAM_23x1024.sh [-step]\n\
Usage: Ture_Dual_Port_RAM_23x1024.sh [-lib_map_path]\n\
Usage: Ture_Dual_Port_RAM_23x1024.sh [-reset_run]\n\
Usage: Ture_Dual_Port_RAM_23x1024.sh [-reset_log]\n\
Usage: Ture_Dual_Port_RAM_23x1024.sh [-keep_index]\n\
Usage: Ture_Dual_Port_RAM_23x1024.sh [-noclean_files]\n\n\
