...
HD_PWD='C:/Users/fossu/Desktop/ML_DSA_Syn_new/IMP2/BU/BU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BU.tcl
