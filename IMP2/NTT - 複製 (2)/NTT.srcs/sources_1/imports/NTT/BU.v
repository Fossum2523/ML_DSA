...
#(
    ...
    input  wire                          mode,
    input  wire                          i_valid,
    input  wire [BIT_LEN - 1:0]          a,  //Individual input points, each 8 bits wide
    input  wire [BIT_LEN - 1:0]          b,
    input  wire [BIT_LEN - 1:0]          zeta,
    output wire                          o_valid,
    output wire [BIT_LEN - 1:0]          out_a,  //Individual output points, each 8 bits wide
    output wire [BIT_LEN - 1:0]          out_b
);
