...
HD_PWD='C:/Users/USER/Desktop/ML_DSA_syn/IMP/SHA3_imp/Sampler/Sampler.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sampler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sampler.tcl
