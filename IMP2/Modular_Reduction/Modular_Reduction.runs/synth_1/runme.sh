...
HD_PWD='C:/Users/fossu/Desktop/ML_DSA_Syn_new/IMP2/Modular_Reduction/Modular_Reduction.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Modular_Reduction.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Modular_Reduction.tcl
