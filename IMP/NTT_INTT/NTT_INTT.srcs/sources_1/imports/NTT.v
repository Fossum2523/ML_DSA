module NTT#(
    ...
    rom #(
        .WIDTH(BIT_LEN),
        .LENGTH(128/depth_1),
        .INIT_FILE("../../../../NTT_INTT.srcs/sources_1/imports/MEM_zeta/MEM_zeta_1.txt")
    ) MEM_zeta_1(
        .clk(clk), 
        .en(1'b1), 
        .addr(zeta_cnt_1), 
    ...
    rom #(
        .WIDTH(BIT_LEN),
        .LENGTH(128/depth_2),
        .INIT_FILE("../../../../NTT_INTT.srcs/sources_1/imports/MEM_zeta/MEM_zeta_2.txt")
    ) MEM_zeta_2(
        .clk(clk), 
        .en(1'b1), 
        .addr(zeta_cnt_2), 
    ...
    rom #(
        .WIDTH(BIT_LEN),
        .LENGTH(128/depth_3),
        .INIT_FILE("../../../../NTT_INTT.srcs/sources_1/imports/MEM_zeta/MEM_zeta_3.txt")
    ) MEM_zeta_3(
        .clk(clk), 
        .en(1'b1), 
        .addr(zeta_cnt_3), 
    ...
    rom #(
        .WIDTH(BIT_LEN),
        .LENGTH(128/depth_4),
        .INIT_FILE("../../../../NTT_INTT.srcs/sources_1/imports/MEM_zeta/MEM_zeta_4.txt")
    ) MEM_zeta_4(
        .clk(clk), 
        .en(1'b1), 
        .addr(zeta_cnt_4), 
    ...
    rom #(
        .WIDTH(BIT_LEN),
        .LENGTH(128/depth_5),
        .INIT_FILE("../../../../NTT_INTT.srcs/sources_1/imports/MEM_zeta/MEM_zeta_5.txt")
    ) MEM_zeta_5(
        .clk(clk), 
        .en(1'b1), 
        .addr(zeta_cnt_5), 
    ...
    rom #(
        .WIDTH(BIT_LEN),
        .LENGTH(128/depth_6),
        .INIT_FILE("../../../../NTT_INTT.srcs/sources_1/imports/MEM_zeta/MEM_zeta_6.txt")
    ) MEM_zeta_6(
        .clk(clk), 
        .en(1'b1), 
        .addr(zeta_cnt_6), 
    ...
    rom #(
        .WIDTH(BIT_LEN),
        .LENGTH(128/depth_7),
        .INIT_FILE("../../../../NTT_INTT.srcs/sources_1/imports/MEM_zeta/MEM_zeta_7.txt")
    ) MEM_zeta_7(
        .clk(clk), 
        .en(1'b1), 
        .addr(zeta_cnt_7), 
