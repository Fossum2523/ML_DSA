...
//     assign x = in[45:43] + in[42:33] + in[32:23];

//     assign y = in[45:43] + in[45:33] + in[45:23];

//     assign z = in[22:0];

//     assign d = x[11:10] + x[9:0];

//     assign e = z - y - x[11:10];

//     assign f = (d << 13) + e;

//     assign adjust = f[23] ? 24'd8380417 : 24'd8396799;

//     assign g = f + adjust;

//     assign out = g[23] ? f[22:0] : g[22:0];
// endmodule
