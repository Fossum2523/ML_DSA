...
HD_PWD='C:/Users/fossu/Desktop/ML_DSA_Syn/IMP/NTT/NTT2/NTT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NTT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NTT.tcl -notrace
