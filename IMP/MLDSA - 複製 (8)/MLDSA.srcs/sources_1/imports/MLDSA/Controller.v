module Controller
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignGen,6'd3}: begin  //take p'' MEM data out to keccak gen y
                AG_1_triger      = ~(keccak_done | keccak_done_tmp);
                AG_1_clean       = next_element;
            end  
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {KeyGen,6'd8}: begin // Enocder t0 TX
                AG_2_triger      = ~Encoder_done_tmp;
                AG_2_clean       = Encoder_done;
            end
            // {KeyGen,6'dT}: begin // Enocder t0 TX
            //     AG_2_triger      = ~Encoder_done_tmp;
            //     AG_2_clean       = Encoder_done;
            // end
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {KeyGen,6'd7}: begin // Enocder t RX
                AG_3_triger      = ~Encoder_done_tmp;
                AG_3_clean       = Encoder_done;
            end 
            {KeyGen,6'd8}: begin // Enocder t RX
                AG_3_triger      = ~Encoder_done_tmp;
                AG_3_clean       = Encoder_done;
            end
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignGen,6'd2}: begin  //after keccak gen p'' , take seed to mem
                AG_4_triger      = sha_out_ready;
                AG_4_clean       = AG_4_done;
            end 
            // {SignGen,6'd3}: begin  //after keccak gen y , take data to y  mem
            //     AG_4_triger      = sha_out_ready;
            //     AG_4_clean       = AG_4_done;
            // end 
