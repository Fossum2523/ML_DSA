...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Ture_Dual_Port_RAM_23x4096 xil_defaultlib.Ture_Dual_Port_RAM_23x4096 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Ture_Dual_Port_RAM_23x4096 -key {Behavioral:sim_1:Functional:Ture_Dual_Port_RAM_23x4096} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Ture_Dual_Port_RAM_23x4096.wdb xsim.dir libdpi.so)
