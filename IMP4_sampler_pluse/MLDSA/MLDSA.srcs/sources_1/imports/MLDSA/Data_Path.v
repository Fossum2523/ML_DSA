module Data_Path(   
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd3},      //"Gen(A)", Store A generated by the Sampler
            {SignVer,6'd4}:begin //"Gen(A)", Store A generated by the Sampler
                temp_A_data_a = A0;
                temp_A_data_b = A1;
                temp_A_addr_a = {A_index,addr_A0};
                temp_A_addr_b = {A_index,addr_A1};
            ...
            {SignVer,6'd5}:begin //"Az_hat = A ‧ z_hat", read out A_hat data to perform the PWM
                temp_A_addr_a = {AG_4_addr_a[9:8], PWM_index, AG_4_addr_a[7:0]};
                temp_A_addr_b = {AG_4_addr_a[9:8], PWM_index, AG_4_addr_b[7:0]};
                temp_A_en_a   = AG_4_addr_en;
                temp_A_en_b   = AG_4_addr_en;
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd5}:begin ////"Az_hat = A ‧ z_hat", Az_hat temp data to perform the PWM
                if(PWM_index[0])begin
                    temp_PWM_addr_a = AG_4_addr_a;
                    temp_PWM_addr_b = AG_4_addr_b;
                    temp_PWM_en_a   = AG_4_addr_en;
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignGen,6'd1}:begin //""Unpack(s1)", Store the s1 obtained from the Decoder.
                ...
                temp_0_en_a   = AG_3_addr_en & DEC_valid_o;
                temp_0_en_b   = AG_3_addr_en & DEC_valid_o;
                temp_0_we_a   = AG_3_addr_en & DEC_valid_o;
                temp_0_we_b   = AG_3_addr_en & DEC_valid_o;
            end
            ...
            {SignVer,6'd2}:begin //"Gen(c)", Store c generated by the Sampler
                temp_0_data_a = ci;
                temp_0_data_b = cj;
                temp_0_addr_a = addr_ci;
                temp_0_addr_b = addr_cj;
                temp_0_en_a   = en_ci;
                temp_0_en_b   = en_cj;
                temp_0_we_a   = we_ci;
                temp_0_we_b   = we_cj;
            end
            {SignVer,6'd3}:begin //"c_hat = NTT(c)", read out c to NTT
                temp_0_addr_a = {NTT_index,AG_2_addr_a[7:0]};
                temp_0_addr_b = {NTT_index,(AG_2_addr_a[7:0] + 8'd128)};
                temp_0_en_a   = AG_2_addr_en;
                temp_0_en_b   = AG_2_addr_en;
            end
            {SignVer,6'd4}:begin //"z_hat = NTT(z)", store z_hat after NTT
                temp_0_data_a = NTT_out_u;
                temp_0_data_b = NTT_out_d;
                temp_0_addr_a = {NTT_index,NTT_addr_u};
                temp_0_addr_b = {NTT_index,NTT_addr_d};
                temp_0_en_a   = NTT_o_valid;
                temp_0_en_b   = NTT_o_valid;
                temp_0_we_a   = NTT_o_valid;
                temp_0_we_b   = NTT_o_valid;
            end
            {SignVer,6'd5}:begin //"Az_hat = A ‧ z_hat", read out z_hat data to perform the PWM
                temp_0_addr_a = {PWM_index, AG_4_addr_a[7:0]};
                temp_0_addr_b = {PWM_index, AG_4_addr_b[7:0]};
                temp_0_en_a   = AG_4_addr_en;
                temp_0_en_b   = AG_4_addr_en;
            end
            {SignVer,6'd6}:begin //"w_hat = Az_hat - ct1_hat", store w_hat after PWM
                temp_0_data_a = PWM_out_a;
                temp_0_data_b = PWM_out_b;
                temp_0_addr_a = PWM_addr_a;
                temp_0_addr_b = PWM_addr_b;
            ...
            {SignVer,6'd7}:begin //"w'aprr = INTT(w_hat)", Read out w_hat data to perform the INTT
                temp_0_addr_a = {NTT_index,AG_2_addr_a[7:0]};
                temp_0_addr_b = {NTT_index,AG_2_addr_b[7:0]};
                temp_0_en_a   = AG_2_addr_en;
                temp_0_en_b   = AG_2_addr_en;
            ...
            {SignVer,6'd8}:begin //"w'1  = UseHint(h,w'aprr)", store w'1 data
                ...
                temp_0_en_b   = UH_poly_valid_o;
                temp_0_we_a   = UH_poly_valid_o;
                temp_0_we_b   = UH_poly_valid_o;
            end
            {SignVer,6'd9}:begin //"Enc_w1 = Encode(w'1) ", read out w'1 to Encooder
                temp_0_addr_a = AG_2_addr_a;
                temp_0_addr_b = AG_2_addr_b;
                temp_0_en_a   = AG_2_addr_en;
                temp_0_en_b   = AG_2_addr_en;
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignGen,6'd2}:begin //"Unpack(s2)", store s2 generated by the Decoder
                ...
                temp_1_en_a   = AG_3_addr_en & DEC_valid_o;
                temp_1_en_b   = AG_3_addr_en & DEC_valid_o;
                temp_1_we_a   = AG_3_addr_en & DEC_valid_o;
                temp_1_we_b   = AG_3_addr_en & DEC_valid_o;
            end
            ...
            {SignVer,6'd2}:begin //"t1_hat = NTT(t1*2^d)", Read out t1 data to perform the NTT
                temp_1_addr_a = {NTT_index,AG_2_addr_a[7:0]};
                temp_1_addr_b = {NTT_index,(AG_2_addr_a[7:0] + 8'd128)};
                temp_1_en_a   = AG_2_addr_en;
                temp_1_en_b   = AG_2_addr_en;
            end
            {SignVer,6'd3}:begin //"c_hat = NTT(c)", store c_hat after NTT
                temp_1_data_a = NTT_out_u;
                temp_1_data_b = NTT_out_d;
                temp_1_addr_a = NTT_addr_u;
                temp_1_addr_b = NTT_addr_d;
                temp_1_en_a   = NTT_o_valid;
                temp_1_en_b   = NTT_o_valid;
                temp_1_we_a   = NTT_o_valid;
                temp_1_we_b   = NTT_o_valid;
            end
            {SignVer,6'd4}:begin //"ct1_hat = c_hat ‧ t1_hat", read out c_hat to PWM
                temp_1_addr_a = AG_4_addr_a[7:0];
                temp_1_addr_b = AG_4_addr_b[7:0];
                temp_1_en_a   = AG_4_addr_en;
                temp_1_en_b   = AG_4_addr_en;
            end
            {SignVer,6'd5}:begin //"Az_hat = A ‧ z_hat", store Az_hat
                if(~PWM_index[0])begin
                    temp_1_addr_a = AG_4_addr_a;
                    temp_1_addr_b = AG_4_addr_b;
                    temp_1_en_a   = AG_4_addr_en;
                    ...
                    temp_1_addr_a = PWM_addr_a;
                    temp_1_addr_b = PWM_addr_b;
                    temp_1_en_a   = PWM_o_valid;
                    temp_1_en_b   = PWM_o_valid;
                    temp_1_we_a   = PWM_o_valid;
                    temp_1_we_b   = PWM_o_valid;
                end
            end
            {SignVer,6'd6}:begin //"w_hat = Az_hat - ct1_hat", read out Az_hat to PWM
                temp_1_addr_a = AG_4_addr_a;
                temp_1_addr_b = AG_4_addr_b;
                temp_1_en_a   = AG_4_addr_en;
                temp_1_en_b   = AG_4_addr_en;
            end
            {SignVer,6'd7}:begin //"w'aprr = INTT(w_hat)", After performing the INTT on w'aprr, the resulting w store here
                temp_1_data_a = NTT_out_u;
                temp_1_data_b = NTT_out_d;
                temp_1_addr_a = {NTT_index,NTT_addr_u};
                temp_1_addr_b = {NTT_index,NTT_addr_d};
            ...
            {SignVer,6'd8}:begin //"w'1  = UseHint(h,w'aprr)", read out w'aprr to Deomposer and get r0 and r1
                temp_1_addr_a = AG_2_addr_a;
                temp_1_addr_b = AG_2_addr_b;
                temp_1_en_a   = AG_2_addr_en;
                temp_1_en_b   = AG_2_addr_en;
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignGen,6'd3}:begin //"Unpack(t0)", Decocder pack_t0 to t0
                ...
                temp_2_en_a   = AG_3_addr_en & DEC_valid_o;
                temp_2_en_b   = AG_3_addr_en & DEC_valid_o;
                temp_2_we_a   = AG_3_addr_en & DEC_valid_o;
                temp_2_we_b   = AG_3_addr_en & DEC_valid_o;
            end
            ...
            {SignVer,6'd2}:begin //"Unpack(z)", store z generated by the Decoder
                temp_2_data_a = DEC_dout[22:0];
                temp_2_data_b = DEC_dout[45:23];
                temp_2_addr_a = AG_3_addr_a;
                temp_2_addr_b = AG_3_addr_b;
            ...
            {SignVer,6'd4}:begin //"z_hat = NTT(z)", read out z to NTT
                temp_2_addr_a = {NTT_index,AG_2_addr_a[7:0]};
                temp_2_addr_b = {NTT_index,(AG_2_addr_a[7:0] + 8'd128)};
                temp_2_en_a   = AG_2_addr_en;
                temp_2_en_b   = AG_2_addr_en;
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd2}:begin //"t1_hat = NTT(t1*2^d)", After performing the NTT on t1, the resulting t1_hat store here
                temp_3_data_a = NTT_out_u;
                temp_3_data_b = NTT_out_d;
                temp_3_addr_a = {NTT_index,NTT_addr_u};
                temp_3_addr_b = {NTT_index,NTT_addr_d};
            ...
            {SignVer,6'd4}:begin //"ct1_hat = c_hat ‧ t1_hat", read out t1_hat to PWM
                temp_3_addr_a = AG_4_addr_a;
                temp_3_addr_b = AG_4_addr_b;
                temp_3_en_a   = AG_4_addr_en;
                temp_3_en_b   = AG_4_addr_en;   
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd4}:begin //"ct1_hat = c_hat ‧ t1_hat", store ct1_hat after PWM
                temp_4_data_a = PWM_out_a;
                temp_4_data_b = PWM_out_b;
                temp_4_addr_a = PWM_addr_a;
                temp_4_addr_b = PWM_addr_b;
            ...
            {SignVer,6'd6}:begin //"w_hat = Az_hat - ct1_hat", read out ct1_hat to PWM
                temp_4_addr_a = AG_4_addr_a;
                temp_4_addr_b = AG_4_addr_b;
                temp_4_en_a   = AG_4_addr_en;
                temp_4_en_b   = AG_4_addr_en;
            end
            default:begin
                temp_4_data_a = 23'd0;
                temp_4_data_b = 23'd0;
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd2}:begin //"Send c_tilde", store c_tilde from MLDSA_in_A
                temp_L_data_a = MLDSA_data_in_A;
                temp_L_addr_a = AG_1_addr_a[3:0];
                temp_L_en_a  =  AG_1_addr_en;
                temp_L_we_a  =  AG_1_addr_en;
            end
            {SignVer,6'd7}:begin //"u = H(𝑡𝑟 || 𝑀′)", read out the seed  tr
                temp_L_addr_a = AG_1_addr_a[3:0];
                temp_L_en_a   = AG_1_addr_en;
            end
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd1}:begin //"Send p", store p from MLDSA_in_A
                ...
                temp_seed_addr_a = AG_1_addr_a[3:0];
                temp_seed_en_a  =  AG_1_addr_en;
                temp_seed_we_a  =  AG_1_addr_en;
            end
            {SignVer,6'd3},      //"Gen(A)", read out the seed  p
            {SignVer,6'd4}:begin //"Gen(A)", read out the seed  p
                temp_seed_addr_a = AG_1_addr_a[3:0];
                temp_seed_en_a  =  AG_1_addr_en;
            end
            {SignVer,6'd7}:begin //"u = H(𝑡𝑟 || 𝑀′)", store u
                temp_seed_data_a = sha_out >> (AG_4_addr_a << 6);
                temp_seed_data_b = sha_out >> (AG_4_addr_b << 6);
                temp_seed_addr_a = AG_4_addr_a[3:0];
                temp_seed_addr_b = AG_4_addr_b[3:0];
            ...
            {SignVer,6'd9}:begin //"c_tilde' = H(u || Enc_w1)", read out u
                temp_seed_addr_a = AG_1_addr_a[3:0];
                temp_seed_en_a  =  AG_1_addr_en;
            end
            default:begin
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd3},        //"Gen(A)", read seed p to keccak
            {SignVer,6'd4}: begin  //"Gen(A)", read seed p to keccak
                AG_1_addr_adder  = 2'd1;
                AG_1_star_addr   = 12'd0;
                AG_1_last_addr   = 12'd3;
            end   
            {SignVer,6'd7}: begin //"u = H(𝑡𝑟 || 𝑀′)",read tr to keccak 
                AG_1_addr_adder  = 2'd1;
                AG_1_star_addr   = 12'd0;
                AG_1_last_addr   = 12'd7;
            end
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
           {KeyGen,6'd3}: begin  //"s1_hat = NTT(s1)"
            ...
            {SignGen,6'd9}: begin  //"H_w = High(w)", read out w
            ...
            {SignVer,6'd8}: begin  //"w'1  = UseHint(h,w'aprr)", read out w'aprr
                AG_2_addr_adder  = 2'd2;
                AG_2_star_addr   = 12'd0;
                AG_2_last_addr   = 12'd1022;
                AG_2_pasue = ~UH_poly_ready_i;
            end
            {SignVer,6'd9}: begin  // "Enc_w1 = Encode(w'1) ", read out w'1
                AG_2_addr_adder  = 2'd2;
                AG_2_star_addr   = 12'd0;
                AG_2_last_addr   = 12'd1022;
            end 
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd1}: begin //"Unpack(t1)", store t1 data
                AG_3_addr_adder  = {DEC_valid_o,1'b0};
                AG_3_star_addr   = 12'd0;
                AG_3_last_addr   = 12'd1022;//speical to add 1 to make wait DEC_valid_o high
            end
            {SignVer,6'd2}: begin //"Unpack(z)", store z data
                AG_3_addr_adder  = {DEC_valid_o,1'b0};
                AG_3_star_addr   = 12'd0;
                AG_3_last_addr   = 12'd1022;//speical to add 1 to make wait DEC_valid_o high
            end
            {SignVer,6'd8}: begin //"w'1  = UseHint(h,w'aprr)", store w'1 data
                AG_3_addr_adder  = {UH_poly_valid_o,1'b0};
                AG_3_star_addr   = 12'd0;
                AG_3_last_addr   = 12'd1022;//speical to add 1 to make wait DEC_valid_o high
            end
            {SignVer,6'd9}: begin  // "Enc_w1 = Encode(w'1) ", cnt Enc_w1 num
                AG_3_addr_adder  = {1'b0,(ENC_valid_o)};
                AG_3_star_addr   = 12'd0;
                AG_3_last_addr   = 12'd96;
            end 
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd7}: begin  //"u = H(𝑡𝑟 || 𝑀′)", after keccak gen u, take tr to mem
                AG_4_addr_adder  = 2'd2;
                AG_4_star_addr   = 12'd0;
                AG_4_last_addr   = 12'd6;
            end
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd7}:begin
                sha_data_valid = (MLDSA_i_valid_A && MLDSA_i_ready_A)| AG_1_data_valid;
            end
            {SignVer,6'd9}:begin
                sha_data_valid = AG_1_data_valid | ENC_valid_o;
            end
    ...
    Sampler Sampler_(
     ...
     always @(*) begin
        ci_previous = 23'd0;
        case (ctrl_sign)
            {SignGen,6'd11}:begin //"Gen(c)"
                ci_previous = temp_3_q_a;
            end
            {SignVer,6'd2}:begin //"Gen(c)"
                ci_previous = temp_0_q_a;
            end
            default:begin
                ci_previous = 23'd0;
            end
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd2}:begin //"t1_hat = NTT(t1*2^d)"
                NTT_i_valid = AG_2_data_valid & NTT_in_ready;
                NTT_o_ready = 1'b1;
                NTT_in_u = temp_1_q_a << 13;
                NTT_in_d = temp_1_q_b << 13; 
            end
            {SignVer,6'd3}:begin //"c_hat = NTT(c)"
                NTT_i_valid = AG_2_data_valid & NTT_in_ready;
                NTT_o_ready = 1'b1;
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd4}:begin //"ct1_hat = c_hat ‧ t1_hat"
                ...
                PWM_i_valid = AG_4_data_valid;
                PWM_o_ready = 1'b1;
                PWM_in_a0   = temp_3_q_a;   //t1_hat
                PWM_in_a1   = temp_1_q_a;   //c_hat
                PWM_in_b0   = temp_3_q_b;   //t1_hat
                PWM_in_b1   = temp_1_q_b;   //c_hat
            end
            {SignVer,6'd5}:begin //"Az_hat = A ‧ z_hat"
                if(PWM_index == 0)begin
                    ...
                    PWM_in_a2 = PWM_index[0] ? temp_PWM_q_a : temp_1_q_a;  //Az_hat
                    PWM_in_b2 = PWM_index[0] ? temp_PWM_q_b : temp_1_q_b;  //Az_hat
                end
                PWM_mode    = MATRIX_VECTOR;
                PWM_i_valid = AG_4_data_valid;
                PWM_o_ready = 1'b1;
                PWM_in_a0   = temp_0_q_a;     //z_hat
                PWM_in_a1   = temp_A_q_a;     //A_hat
                PWM_in_b0   = temp_0_q_b;     //z_hat
                PWM_in_b1   = temp_A_q_b;     //A_hat
            end
            {SignVer,6'd6}:begin //"w_hat = Az_hat - ct1_hat"
                ...
                PWM_i_valid = AG_4_data_valid;
                PWM_o_ready = 1'b1;
                PWM_in_a1   = 23'd8380417 - temp_4_q_a;   //cs2
                PWM_in_a2   = temp_1_q_a;   //w
                PWM_in_b1   = 23'd8380417 - temp_4_q_b;   //cs2
                PWM_in_b2   = temp_1_q_b;   //w
            end
            default:begin
                PWM_mode  = 2'd0;
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd9}:begin //"Enc_w1 = Encode(w'1) " 
                ENC_encode_mode = 3'd4;
                ENC_di = {temp_0_q_b,temp_0_q_a};
                ENC_valid_i = AG_2_data_valid;
                ENC_ready_o = 1'b1;
    ...
    Decoder Dec_(
     ...
     always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd2}:begin //"Unpack(z)", Decode the pack_z data received from the testbench
                DEC_mode = 3'd5;
                DEC_di = MLDSA_data_in_B;
                DEC_valid_i = MLDSA_i_valid_B & MLDSA_i_ready_B;
                DEC_ready_o = 1'b1;
    ...
    always @(*) begin
        ...
        case (ctrl_sign)
            ...
            {SignVer,6'd8}:begin //"w'1  = UseHint(h,w'aprr)", decomposer w'aprr to r0 and r1，then to usehint
                Decomp_valid_i = AG_2_data_valid;
                Decomp_di      = {temp_1_q_b,temp_1_q_a};
                Decomp_ready_o = 1'b1;
            end
    ...
    usehint usehint_(
        ...
        .poly0_i(UH_poly0_i),
        .poly1_i(UH_poly1_i),
        .poly_valid_i(UH_poly_valid_i),
        .poly_ready_i(UH_poly_ready_i),
        .poly_o(UH_poly_o),
        .poly_valid_o(UH_poly_valid_o),
        .poly_ready_o(UH_poly_ready_o)
    );
