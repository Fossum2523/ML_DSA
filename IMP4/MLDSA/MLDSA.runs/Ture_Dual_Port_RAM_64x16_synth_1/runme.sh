...
HD_PWD='C:/Users/fossu/Desktop/ML_DSA_Syn_new/IMP3/MLDSA/MLDSA.runs/Ture_Dual_Port_RAM_64x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ture_Dual_Port_RAM_64x16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ture_Dual_Port_RAM_64x16.tcl
