...
HD_PWD='C:/Users/fossu/Desktop/ML_DSA_Syn_new/IMP3/MLDSA/MLDSA.runs/Ture_Dual_Port_RAM_23x4096_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ture_Dual_Port_RAM_23x4096.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ture_Dual_Port_RAM_23x4096.tcl
