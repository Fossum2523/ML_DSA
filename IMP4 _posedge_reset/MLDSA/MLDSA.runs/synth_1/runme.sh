...
HD_PWD='C:/Users/USER/Desktop/ML_DSA_syn_new/IMP4/MLDSA/MLDSA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MLDSA_AXI_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MLDSA_AXI_Top.tcl
