...
def NTT(NTT_in):
    ...
    ### To produce verilog need zeta mem data
    # if os.path.exists("MEM_zeta_0.txt"):
    #     os.remove("MEM_zeta_0.txt")
    # for i in MEM_zeta_0:
    #     with open("MEM_zeta_0.txt", "a") as file:
    #         file.write(str(hex(i)))
    #         file.write("\n")

    # if os.path.exists("MEM_zeta_1.txt"):
    #     os.remove("MEM_zeta_1.txt")
    # for i in MEM_zeta_1:
    #     with open("MEM_zeta_1.txt", "a") as file:
    #         file.write(str(hex(i)))
    #         file.write("\n")

    # if os.path.exists("MEM_zeta_2.txt"):
    #     os.remove("MEM_zeta_2.txt")
    # for i in MEM_zeta_2:
    #     with open("MEM_zeta_2.txt", "a") as file:
    #         file.write(str(hex(i)))
    #         file.write("\n")

    # if os.path.exists("MEM_zeta_3.txt"):
    #     os.remove("MEM_zeta_3.txt")
    # for i in MEM_zeta_3:
    #     with open("MEM_zeta_3.txt", "a") as file:
    #         file.write(str(hex(i)))
    #         file.write("\n")

    # if os.path.exists("MEM_zeta_4.txt"):
    #     os.remove("MEM_zeta_4.txt")
    # for i in MEM_zeta_4:
    #     with open("MEM_zeta_4.txt", "a") as file:
    #         file.write(str(hex(i)))
    #         file.write("\n")

    # if os.path.exists("MEM_zeta_5.txt"):
    #     os.remove("MEM_zeta_5.txt")
    # for i in MEM_zeta_5:
    #     with open("MEM_zeta_5.txt", "a") as file:
    #         file.write(str(hex(i)))
    #         file.write("\n")

    # if os.path.exists("MEM_zeta_6.txt"):
    #     os.remove("MEM_zeta_6.txt")
    # for i in MEM_zeta_6:
    #     with open("MEM_zeta_6.txt", "a") as file:
    #         file.write(str(hex(i)))
    #         file.write("\n")

    # if os.path.exists("MEM_zeta_7.txt"):
    #     os.remove("MEM_zeta_7.txt")
    # for i in MEM_zeta_7:
    #     with open("MEM_zeta_7.txt", "a") as file:
    #         file.write(str(hex(i)))
    #         file.write("\n")
...
if os.path.exists("s1_0.txt"):
    os.remove("s1_0.txt")

for i in s1[0]:
    with open("s1_0.txt", "a") as file:
        file.write(str(hex(i % 8380417)[2:]))
        file.write("\n")
